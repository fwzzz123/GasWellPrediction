...
//
//            String wellName = file.getOriginalFilename().split("_")[0];
//            Integer wellId;
//
//            WellInfoPO existing = wellInfoService.getByWellName(wellName);
//            if (existing == null) {
//                WellInfoPO wellInfo = new WellInfoPO();
//                wellInfo.setWellName(wellName);
//                if (wellName.startsWith("BD")) {
//                    wellInfo.setReservoirId(1);
//                } else if (wellName.startsWith("DF1-")) {
//                    wellInfo.setReservoirId(2);
//                } else if (wellName.startsWith("DF13")) {
...
//                wellId = wellInfo.getWellId();  // 主键自动回填
//            } else {
//                wellId = existing.getWellId();
//            }
//
//            wellLasInfoMap.put("wellId", wellId.toString());
//
//
//
